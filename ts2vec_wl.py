...
from models.encoder_Transformer_sim import TransAm
from models.encoder_wl import SLNet_0, SLNet_1, Transformer, SLNet
...
class TS2Vec_wl:
    ...
    def __init__(
        ...
        # self._net = TransAm().to(self.device)
    ...
    # def fit(self, train_data, more_train_laebls, n_epochs=None, n_iters=None, verbose=False):
        ...
        while True:
            ...
            for batch_x, batch_y1, batch_y2 in train_loader:
                ...
                abc, bcd = lifting_sfa(abc, bcd, sub_length=int(576*split_point*0.9), dim=10, n_comp=1)
                abc = abc.to(self.device)
                bcd = bcd.to(self.device)
    ...
    def _eval_with_pooling(self, x, mask=None, slicing=None, encoding_window=None):
        ...
        # out = self._net(x.to(self.device, non_blocking=True))
